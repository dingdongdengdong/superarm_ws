...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/nav2_localization_adapter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_localization_adapter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_localization_adapter/environment/path.sh"
